...
• Detect patterns in multi-category purchasing behavior.
...
• AI and Machine Learning category generates the highest revenue and has the largest
number of unique learners.

• Data Science and Cybersecurity courses have lower purchase counts but still significant
revenue, suggesting niche engagement.
...
Offer promotions or discounts on courses that are under-purchased.
